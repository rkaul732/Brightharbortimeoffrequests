...
export async function handler(event) {
  ...
  try {
    ...
    const admins = members
      .filter((member) => member.account_type === "admin" || member.account_type === "super_admin")
      .map(adminOption);

    return json(200, { members, admins });
  } catch (error) {
...
function sortProfiles(accounts) {
